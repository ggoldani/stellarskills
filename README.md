...
| **OpenZeppelin Relayer** | [`/openzeppelin-relayer/SKILL.md`](https://raw.githubusercontent.com/ggoldani/stellarskills/main/openzeppelin-relayer/SKILL.md) | OpenZeppelin Relayer for Stellar — reliable transaction submission, fee management, and tracking for Soroban smart contracts. |
...
| **Oracles** | [`/oracles/SKILL.md`](https://raw.githubusercontent.com/ggoldani/stellarskills/main/oracles/SKILL.md) | Oracles on Stellar (Soroban). Reflector, Band Protocol, DIA Oracles. Price feeds for smart contracts. |
...
| **Stellar Disbursement Platform** | [`/stellar-disbursement-platform/SKILL.md`](https://raw.githubusercontent.com/ggoldani/stellarskills/main/stellar-disbursement-platform/SKILL.md) | Stellar Disbursement Platform (SDP) overview, bulk payments, architecture and APIs. |
...
| **Cross-Chain** | [`/cross-chain/SKILL.md`](https://raw.githubusercontent.com/ggoldani/stellarskills/main/cross-chain/SKILL.md) | Cross-chain integration on Stellar. Circle CCTP (Cross-Chain Transfer Protocol) for native USDC and Axelar for GMP (General Message Passing) and ITS (Interchain Token Service). |
